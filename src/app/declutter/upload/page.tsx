...
//     // Create preview URLs for new images and combine with existing ones
...
//         formData.append('upload_preset', 'spanky'); // Use your preset name here
//         formData.append('cloud_name', 'dfz5jgfxo'); // Your cloud name
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl shadow-sm">
          <div>
            ...
            <input
              type="text"
              required
              className="w-full px-4 py-2 border bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              value={formData.title}
              onChange={(e) => setFormData({ ...formData, title: e.target.value })}
            />
          </div>
