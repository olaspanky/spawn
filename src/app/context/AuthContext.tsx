...
// const BASE_URL = "https://spawnback.onrender.com/api" ;
...
//   return (
//     <AuthContext.Provider value={{ token, user, isSigningUp, isVerifyingOTP, signup, verifyOTP, googleSignup, login, logout }}>
//       {children}
