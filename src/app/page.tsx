...
//             Sell Your Clutter in <span className="text-orange-600">Two Taps</span>
//           </h2>

//           <button className="bg-orange-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-orange-700 transition-colors shadow-lg hover:shadow-xl">
//           <Link 
// href="/declutter/upload">
//             Sell Now

// </Link>
//             <ShoppingCartIcon className="h-5 w-5 ml-2 inline-block" />
//           </button>
//           <p className="mt-4 text-gray-600">No stress. No fees. Just cash.</p>
//         </div>
//       </div>
...
//           <input
//             type="text"
//             placeholder="Search for chairs, phones, dresses..."
//             className="w-full py-4 pl-12 pr-4 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
//             value={searchTerm}
...
//       {/* Recent Listings */}
//       <div className="max-w-6xl mx-auto px-4 mb-16">
//         <h3 className="text-xl font-semibold text-gray-900 mb-6">Trending Near You</h3>
...
//             🔒 Your safety is our priority - All sellers are verified
//           </p>
//         </div>
//       </footer>
//     </div>
